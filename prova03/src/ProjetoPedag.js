...
function ProjetoPedag() {
    return(
        <>
            <Navbar/>  
            <main className="m-4">
                <Titulos tit="Projeto Pedagógico do Curso"/>
                <section className="mx-4 mt-4">
                    <article>
                        <SubTitulos tit="Perfil Profissional" />
                        <p className="px-2">
                        ...
                        <SubTitulos tit="Competências e Habilidades do Profissional" />
                        <ol>
                        ...
                        <SubTitulos tit="Avaliação do Curso" />
                        <p className="px-2">
                            Após a atualização do Projeto Pedagógico do Curso, este deverá ser continuamente avaliado pelo Núcleo Docente Estruturante (NDE) e Colegiado do Curso para assegurar o processo de consolidação do mesmo. <br />
                            O NDE será composto por 5 (cinco) docentes pertencentes ao corpo docente do Curso, com doutorado obtido em programa de pós-graduação stricto sensu, e em regime de trabalho de tempo integral. <br />
                            Será assegurada a renovação parcial (dois integrantes) a cada 3 anos, de modo a garantir a continuidade no processo de acompanhamento do Curso, estando o Núcleo, dessa forma, de acordo com a Resolução Nº 01, de 17 de junho de 2010, da Comissão Nacional de Avaliação da Educação Superior (CONAES).<br />
                            Serão realizadas Ações Acadêmico-Administrativas para aprimoramento contínuo do planejamento do curso. Tais ações deverão ser realizadas em decorrência de:<br />
                        </p>
                        <ul>
